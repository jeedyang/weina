/********************************************************************************
** Form generated from reading UI file 'debugwidgetKcjDsS.ui'
**
...
#ifndef DEBUGWIDGETKCJDSS_H
#define DEBUGWIDGETKCJDSS_H
...
"}"));
    ...
    void retranslateUi(QWidget *DebugWidget)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab), QCoreApplication::translate("DebugWidget", "Tab 1", nullptr));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QCoreApplication::translate("DebugWidget", "Tab 2", nullptr));
    } // retranslateUi
